    ...
    <div className="bg-surface-bright text-on-surface min-h-screen flex flex-col">
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-gutter py-xl">
        ...
        <article className="prose max-w-none font-body-lg text-body-lg text-on-surface-variant space-y-xl">
            ...
            <div className="grid md:grid-cols-2 gap-lg">
              <div className="bg-surface-container-low p-md rounded-xl border border-outline-variant">
                ...
                <ul className="list-disc pl-lg space-y-sm text-body-md marker:text-secondary">
                  <li>
                    <strong>Newsletter signup:</strong> your email address, if you subscribe.
                  </li>
                  <li>
                    <strong>Contact form:</strong> your name, email address, and message content.
                  </li>
                </ul>
                <p className="mt-md text-body-sm italic">
                  We do not require account creation, and we never ask for payment info or
                  government ID.
                </p>
              </div>
              <div className="bg-surface-container-low p-md rounded-xl border border-outline-variant">
          ...
          <section>
            ...
            <div className="mt-md p-md bg-secondary/10 border-l-4 border-secondary rounded-r-lg">
              <p className="text-on-surface font-medium text-body-md">
                We do not sell your personal information. We do not use your data to make automated
          ...
          <section>
            ...
            <div className="space-y-md">
              <div className="bg-surface-container-lowest p-md rounded-lg border border-outline-variant">
                ...
                The Site uses cookies (small text files stored on your device) for essential site
                functionality, analytics, and advertising. You can control cookies through your
              ...
              <div className="bg-surface-container-lowest p-md rounded-lg border border-outline-variant">
                ...
                We use Google Analytics to understand aggregate visitor behavior. Google Analytics
                uses cookies to collect standard internet log and visitor behavior information in an
                anonymized form. Learn more at{" "}
                <a
              ...
              <div className="bg-surface-container-lowest p-md rounded-lg border border-outline-variant">
                ...
                We use Google AdSense to display advertising. Google and its partners use cookies to
          ...
          <section>
            <h2 className="font-headline-md text-headline-md text-primary mb-md">
              5. Data Sharing, Disclosure & Retention
            </h2>
            <p className="mb-sm">
            ...
            <ul className="list-disc pl-xl space-y-sm mb-md marker:text-secondary">
              <li>
                Service providers who perform functions on our behalf, bound by their own privacy
                obligations
              </li>
              <li>
                Legal authorities, if required by law, subpoena, or to protect the rights, property,
                or safety of CryptoBeacon, our users, or others
              </li>
              <li>A successor entity, in the event of a merger, acquisition, or sale of assets</li>
            </ul>
            <p>
              <strong>Data Retention:</strong> We retain newsletter and contact-form data for as
              long as necessary to provide the relevant service, or until you request deletion.
          ...
          <section>
            ...
            <p>
              <strong>EU/UK visitors (GDPR):</strong> Our legal basis for processing your data is
              your consent (newsletter, contact form) or our legitimate interest in operating and
              improving the Site (analytics, security). You have the right to lodge a complaint with
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-md">
              <div className="bg-surface-container-low p-md rounded-lg border border-outline-variant">
                <strong className="text-primary block mb-xs text-body-lg">
                  Children's Privacy
                </strong>
                <p className="text-body-md">
                  CryptoBeacon is not directed at children under 13 (or under 16 in the EU), and we
              ...
              <div className="bg-surface-container-low p-md rounded-lg border border-outline-variant">
                ...
                <p className="text-body-md">
                  ...
                  information, including HTTPS encryption for all Site traffic.
                </p>
              </div>
              <div className="bg-surface-container-low p-md rounded-lg border border-outline-variant">
