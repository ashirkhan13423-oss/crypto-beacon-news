...
const websiteSchema = {
  ...
  url: `${SITE_URL}/`,
  description:
    "Institutional-grade analysis, guides, and security research on Bitcoin, Ethereum, and major cryptocurrencies, focusing on crypto education, self-custody, and market analysis.",
  potentialAction: {
    "@type": "SearchAction",
