...
const DESC = "A guide to how cryptocurrency exchanges are regulated — licensing regimes, geographic restrictions, asset listing rules, and how exchanges handle regulatory ...";
...
export const Route = createFileRoute("/guides/how-crypto-exchanges-are-regulated")({
  head: () => ({
    ...buildMetadata({ title: TITLE, description: DESC, url: URL, type: 'article', path: '/guides/how-crypto-exchanges-are-regulated', publishedTime: PUBLISHED, section: 'Guides' }),
    
    
    scripts: [
      { type: "application/ld+json", children: JSON.stringify(buildArticleSchema({ headline: "How Crypto Exchanges Are Regulated: Licensing & Compliance | CryptoBeacon", description: "A guide to how cryptocurrency exchanges are regulated — licensing regimes, geographic restrictions, asset listing rules, and how exchanges handle regulatory ...", imageUrl: `https://www.cryptobeacon.site${""}`, datePublished: "2026-09-01", dateModified: "2026-09-01", url: "https://www.cryptobeacon.site/guides/how-crypto-exchanges-are-regulated", section: "Guides", isNews: false })) },
      { type: "application/ld+json", children: JSON.stringify(buildFAQSchema(faqs)) },
      { type: "application/ld+json", children: JSON.stringify(buildBreadcrumbSchema([
        { name: "Home", item: "https://www.cryptobeacon.site/" },
        { name: "Guides", item: "https://www.cryptobeacon.site/guides" },
        { name: "How Crypto Exchanges Are Regulated: Licensing & Compliance | CryptoBeacon", item: "https://www.cryptobeacon.site/guides/how-crypto-exchanges-are-regulated" }
      ])) }
    ],
  }),
  ...
  return (
    <div className="bg-surface-bright text-on-surface min-h-screen flex flex-col">
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-gutter py-xl">
        ...
        <P>Because regulation varies wildly by country, exchanges use "geofencing" — restricting access based on a user's location (via IP address and <Link to="/glossary#kyc" className="text-secondary hover:underline decoration-secondary/50 underline-offset-4" title="Glossary: KYC">KYC</Link> data). This leads to a fragmented market:</P>
