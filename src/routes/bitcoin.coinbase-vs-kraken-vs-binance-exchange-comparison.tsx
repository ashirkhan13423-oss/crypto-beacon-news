...
import hero from "@/assets/exchange-comparison.webp";
...
export const Route = createFileRoute("/bitcoin/coinbase-vs-kraken-vs-binance-exchange-comparison")({
  head: () => ({
    ...buildMetadata({ title: TITLE, description: DESC, url: URL, type: 'article', path: '/bitcoin/coinbase-vs-kraken-vs-binance-exchange-comparison', publishedTime: PUBLISHED, section: 'Bitcoin' }),
    
    
    scripts: [
      { type: "application/ld+json", children: JSON.stringify(buildArticleSchema({ headline: "Coinbase vs Kraken vs Binance: Which Crypto Exchange Is Right for You? | CryptoBeacon", description: "A first-hand comparison of Coinbase, Kraken, and Binance across fees, security, coin support, and ease of use — helping you choose the right exchange for you...", imageUrl: `https://www.cryptobeacon.site${hero}`, datePublished: "2026-08-25", dateModified: "2026-08-25", url: "https://www.cryptobeacon.site/bitcoin/coinbase-vs-kraken-vs-binance-exchange-comparison", section: "Bitcoin", isNews: false })) },
      { type: "application/ld+json", children: JSON.stringify(buildBreadcrumbSchema([
        { name: "Home", item: "https://www.cryptobeacon.site/" },
        { name: "Bitcoin", item: "https://www.cryptobeacon.site/bitcoin" },
        { name: "Coinbase vs Kraken vs Binance: Which Crypto Exchange Is Right for You? | CryptoBeacon", item: "https://www.cryptobeacon.site/bitcoin/coinbase-vs-kraken-vs-binance-exchange-comparison" }
      ])) }
    ],
  }),
      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-gutter py-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-md my-lg">
          ...
          <div className="p-lg rounded-xl bg-[#5741D9]/10 border border-[#5741D9]/30">
            ...
            <p className="font-body-sm text-body-sm text-on-surface-variant">You want competitive fees, proven security, and <Link to="/glossary#staking" className="text-secondary hover:underline decoration-secondary/50 underline-offset-4" title="Glossary: Staking">staking</Link> support without navigating Binance's complexity or Coinbase's fees.</p>
          </div>
