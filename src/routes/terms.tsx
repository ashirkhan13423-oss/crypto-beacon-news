      ...
      <main className="flex-grow w-full max-w-4xl mx-auto px-gutter py-xl">
        ...
        <article className="prose max-w-none font-body-lg text-body-lg text-on-surface-variant space-y-xl">
          <section className="bg-surface-container-lowest p-lg md:p-xl rounded-2xl border border-outline-variant shadow-sm">
            ...
            <p className="mb-sm">
              By accessing or using CryptoBeacon ("the Site"), you agree to be bound by these Terms
              of Service ("Terms"). If you do not agree, do not use the Site.
            </p>
          </section>
          ...
          <section className="bg-secondary/10 border-l-4 border-secondary p-lg rounded-r-xl">
            ...
            <p className="text-on-surface font-medium">
              ...
              Cryptocurrency is volatile and carries substantial risk, including risk of total loss.
              You should conduct your own research and consult a licensed financial or legal
              professional before making any decisions involving cryptocurrency. CryptoBeacon and
              its authors are not liable for any financial loss resulting from actions taken based
              on Site content.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All content on this Site — including text, graphics, logos, and the CryptoBeacon name
              and mark — is the property of CryptoBeacon or its licensors and is protected by
              copyright and trademark law. You may not reproduce, distribute, or create derivative
              works from Site content without our prior written permission, except for personal,
              non-commercial use with proper attribution and a link back to the original page.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-surface-container-low p-lg rounded-xl border border-outline-variant">
              ...
              <ul className="list-disc pl-lg space-y-sm text-body-md marker:text-secondary">
                ...
                <li>
                  Interfere with the Site's normal operation, including through excessive automated
                  requests
                </li>
          ...
          <section>
            <div className="grid md:grid-cols-2 gap-lg">
              <div>
                ...
                <p>
                  The Site may contain links to third-party websites and displays third-party
                  advertising. We do not control, endorse, or take responsibility for the content,
                  products, services, or privacy practices of any third-party site. Interactions
              ...
              <div>
                ...
                <p>
                  The Site is monetized in part through Google AdSense and may in the future include
                  affiliate links or sponsored content. Any sponsored or affiliate content will be
                  clearly disclosed as such in accordance with FTC guidelines and applicable
            ...
            <div className="space-y-md">
              <div>
                ...
                <p className="text-body-md">
                  ...
                  warranties of any kind, express or implied. While we strive to keep content
                  current and accurate, we do not guarantee it is free of errors or fully up to date
                  at all times.
                </p>
              </div>
              <div>
                ...
                <p className="text-body-md">
                  To the fullest extent permitted by law, CryptoBeacon and its owners, authors, and
                  ...
                  cryptocurrency, arising from your use of, or inability to use, the Site or its
                  content.
                </p>
              </div>
              <div>
                ...
                <p className="text-body-md">
                  You agree to indemnify and hold CryptoBeacon harmless from any claims, damages, or
            ...
            <ul className="space-y-md list-none pl-0">
              ...
              <li className="flex gap-md">
                ...
                <div>
                  ...
                  We reserve the right to restrict or terminate your access to the Site at our
          ...
          <section className="bg-surface-container-high p-lg rounded-xl border border-outline-variant flex flex-col md:flex-row items-center justify-between gap-md mt-xxl">
            ...
            <a
              href="mailto:legal@cryptobeacon.site"
