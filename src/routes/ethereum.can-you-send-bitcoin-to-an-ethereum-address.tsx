...
export const Route = createFileRoute(
  ...
  head: () => ({
    ...buildMetadata({ title: TITLE, description: DESC, url: URL, type: 'article', path: '/ethereum/can-you-send-bitcoin-to-an-ethereum-address', publishedTime: PUBLISHED, section: 'Ethereum' }),
    
    
    scripts: [
      { type: "application/ld+json", children: JSON.stringify(buildArticleSchema({ headline: "Can You Send Bitcoin to an Ethereum Address? What Actually Happens | CryptoBeacon", description: "Worried you sent Bitcoin to an Ethereum address by mistake? Here's what actually happens, why it's rarer than you think, and what to check.", imageUrl: `https://www.cryptobeacon.site${heroImage}`, datePublished: "2026-08-15", dateModified: "2026-08-15", url: "https://www.cryptobeacon.site/ethereum/can-you-send-bitcoin-to-an-ethereum-address", section: "Ethereum", isNews: false })) },
      { type: "application/ld+json", children: JSON.stringify(buildFAQSchema(faqs)) },
      { type: "application/ld+json", children: JSON.stringify(buildBreadcrumbSchema([
        { name: "Home", item: "https://www.cryptobeacon.site/" },
        { name: "Ethereum", item: "https://www.cryptobeacon.site/ethereum" },
        { name: "Can You Send Bitcoin to an Ethereum Address? What Actually Happens | CryptoBeacon", item: "https://www.cryptobeacon.site/ethereum/can-you-send-bitcoin-to-an-ethereum-address" }
      ])) }
    ],
  }),
        ...
        <div className="my-xl p-lg rounded-xl border border-outline-variant bg-[#EA4335]/5 shadow-sm flex items-start gap-md">
          ...
          <div>
            ...
            <p className="font-body-md text-body-md text-on-surface leading-relaxed">
              Bitcoin and Ethereum run on completely separate <Link to="/glossary#blockchain" className="text-secondary hover:underline decoration-secondary/50 underline-offset-4" title="Glossary: Blockchain">blockchains</Link> with distinct address rules. Sending native Bitcoin to an Ethereum 0x address directly will fail validation in most modern <Link to="/glossary#wallet" className="text-secondary hover:underline decoration-secondary/50 underline-offset-4" title="Glossary: Wallet">wallets</Link>, preventing transaction loss.
            </p>
          </div>
        </div>
